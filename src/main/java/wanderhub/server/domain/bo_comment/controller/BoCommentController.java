...
public class BoCommentController {
    ...
    public ResponseEntity postBoardComment(Principal principal,
    ...
    public ResponseEntity patchBoardComment(@PathVariable("board-id")Long boardId,
    ...
    public ResponseEntity likeBoardComment(@PathVariable("board-id")Long boardId,
                                           @PathVariable("comment-id")Long commentId,
                                           Principal principal) {
